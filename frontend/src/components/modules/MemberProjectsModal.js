...
import { X, Rocket, CheckCircle, Clock, Play, ChevronRight } from 'lucide-react';
...
const MemberProjectsModal = ({ onClose, onUpdate }) => {
  ...
  const getProgressForProject = (project) => {
        ...
        <div className="border-b border-white/10 p-4 sm:p-6 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h2 className="font-rajdhani font-bold text-lg sm:text-2xl uppercase tracking-wide">
              {selectedProject ? selectedProject.business_name : 'MY ACTIVE PROJECTS'}
            </h2>
          </div>
          <button
            onClick={() => {
              ...
              {projects.length === 0 ? (
                ...
                projects.map((project) => (
                  ...
                  >
                    ...
                    <div className="font-mono text-xs text-payload-muted mb-2">
...
// Task List Component
const TaskListView = ({ project, tasks, token, onTaskUpdate }) => {
