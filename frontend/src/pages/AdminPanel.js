        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto">
              ...
              <button onClick={() => navigate('/admin/member-progress')} className="flex items-center gap-1 font-mono text-[10px] sm:text-xs border border-purple-500 text-purple-500 px-2 py-1.5 hover:bg-purple-500 hover:text-black transition-all"><TrendingUp className="w-3 h-3" /><span className="hidden sm:inline">PROGRESS</span></button>
