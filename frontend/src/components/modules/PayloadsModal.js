...
import { X, Plus, Edit, Trash2, Rocket } from 'lucide-react';
...
const PayloadsModal = ({ onClose, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ title: '', description: '', funding_goal: 0, current_funding: 0 });
      setEditingId(null);
      setShowForm(false);
      fetchPayloads();
      onUpdate();
      ...
      >
        <div className="border-b border-white/10 p-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-rajdhani font-bold text-2xl uppercase tracking-wide">PAYLOADS</h2>
          </div>
          <button
          ...
          {showForm && (
            <form onSubmit={handleSubmit} className="bg-black/30 border border-white/10 p-6 rounded-sm mb-6">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  type="button"
                  onClick={() => { setShowForm(false); setEditingId(null); setFormData({ title: '', description: '', funding_goal: 0, current_funding: 0 }); }}
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <h3 className="font-rajdhani font-bold text-xl uppercase tracking-wide text-payload-neon mb-2">
                        {payload.title}
                      </h3>
